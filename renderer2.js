    ...
    box.innerHTML = list.map((g) => {
      ...
      return `<div class="card" style="padding:14px 16px">
        <div style="display:flex;justify-content:space-between;gap:10px;align-items:flex-start;flex-wrap:wrap">
          ...
          <span style="font-size:10px;font-weight:700;letter-spacing:.04em;padding:4px 8px;border-radius:999px;background:rgba(255,255,255,.06);color:${badgeCol}">${badge}</span>
        </div>
        <div style="display:flex;justify-content:space-between;align-items:center;margin-top:12px;gap:10px;flex-wrap:wrap">
          <span class="set-desc" style="margin:0">${open ? timeStr : (winner || 'Ended')}</span>
          ${open
